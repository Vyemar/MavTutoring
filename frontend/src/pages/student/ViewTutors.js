      ...
      <div className={styles.mainContent}>
        ...
        <div className="App">
          <div className="search-bar-container">
            <SearchBar allTutors={allTutors} setResults = {setResults}/> {/*Creates a searchbar the user can enter inputs in*/}
            {/*<SearchResultsList results = {results}/>/*Takes results from user input and lists Tutor profile name suggestions*/}
          </div>
            <SearchResultsTutorProfiles results = {results}/> {/*Takes results from user input and lists Tutor profile cards*/}
        </div>
      </div>
    </div>
  );
