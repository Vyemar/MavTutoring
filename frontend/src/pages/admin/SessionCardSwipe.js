            ...
            <div className={styles.mainContent}>
                ...
                <div className={styles.cardReaderBox}>
                    <p className={styles.instruction}>
                        Swipe your ID card to check in or out of your session.
                    </p>
                    ...
                    {sessionDetails && (
                        <div className={styles.sessionBox}>
                            ...
                            <p><strong>Tutor:</strong> {sessionDetails.tutorName}</p>
                            <p><strong>Student:</strong> {sessionDetails.studentName}</p>
                            <p><strong>Time:</strong> {new Date(sessionDetails.sessionTime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
